...
export default function DashBoard(props) {
  ...
  // Vérification explicaite que activity est un tableau
  // et création des cartes d'activités
  // Si activity n'est pas un tableau, levelsCards sera un tableau vide
